...
def install_native_shell(window, root):
    ...
    header.setObjectName('nativeHeader')
    header.setAttribute(Qt.WA_StyledBackground, True)
    header.setStyleSheet('QWidget#nativeHeader {background-color: #080F16;}')
    ...
    for widget, rect in ((window.connection_label, (350, 16, 180, 35)),
        ...
        widget.show()
    # Keep status updates intact, but do not display them in the header.
    window.connection_label.hide()
